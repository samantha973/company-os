...
// assume theprhub.com.au. This map is the single source of truth for that routing.
//
...
const SITES: Record<string, BrandSite> = {
  edge8: { slug: "edge8", domain: "https://theprhub.com.au", self: true, blogEnabled: true },

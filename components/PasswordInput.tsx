...
export function PasswordInput({
  ...
  return (
    <span className="site-pw-wrap" style={wrapperStyle} /* layout-ok: caller-supplied wrapper style */>
      <input
        ...
        autoFocus={autoFocus}
        className="site-pw-input" style={inputStyle} /* layout-ok: caller-supplied input style */
      />
      <button
        type="button"
        onClick={() => setShow((s) => !s)}

...
export const metadata: Metadata = {
  title: 'The PR Hub · Privacy Policy',
  description: 'How The PR Hub collects, uses, and protects your information.',
}
    ...
    <div className="site-xp-page">
      <article className="site-xp-article">
        ...
        <PageHeader
          ...
          lead="This policy explains what information The PR Hub (“The PR Hub,” “we,” “us”), collects across our website, client portal, and related services, and how we use, share, and protect it."
        />
        ...
        <div className="site-xp-blocks">
          ...
          <Block heading="How we use your information">
            ...
            <p>
              <strong>Marketing email.</strong> If you are a client of The PR Hub, or you gave us your
          ...
          <Block heading="How we share your information">
            <p>
              We share information with service providers who help us run The PR Hub, under
          ...
          <Block heading="Your rights and choices">
            <p>
              ...
              emailing{' '}
              <a href="mailto:hello@theprhub.com.au">hello@theprhub.com.au</a>. Depending on where you live, you
            ...
            <p>
              ...
              <a href="mailto:hello@theprhub.com.au">hello@theprhub.com.au</a>. Unsubscribing from marketing does

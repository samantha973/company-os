...
// The hub Overview: the same top band as the admin hub home, the PR Programs
// card grid, each card linking into the team program view. The company-wide
// surfaces (board, roadmap, documents, meetings, invoices, team) stay on their
// own tabs below.
